...
#ifndef SWIG_mtd_lib_WRAP_H_
#define SWIG_mtd_lib_WRAP_H_

#include <map>
#include <string>


class SwigDirector_ScriptSkillCallback : public ScriptSkillCallback, public Swig::Director {
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        if (!method) {
          std::string msg = "Method in class ScriptSkillCallback doesn't exist, undefined ";
          msg += method_name;
